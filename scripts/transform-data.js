...
// src/iso-8859-13.src.mjs → iso-8859-13.mjs
const LIB_TEMPLATE = fs.readFileSync('./src/iso-8859-13.src.mjs', 'utf8');
const createLib = template(LIB_TEMPLATE, TEMPLATE_OPTIONS);
const libCode = createLib(require('./export-data.js'));
fs.writeFileSync('./iso-8859-13.mjs', libCode);

// src/iso-8859-13.d.ts → iso-8859-13.d.ts
const TYPES_TEMPLATE = fs.readFileSync('./src/iso-8859-13.d.ts', 'utf8');
const createTypes = template(TYPES_TEMPLATE, TEMPLATE_OPTIONS);
const typesCode = createTypes(require('./export-data.js'));
fs.writeFileSync('./iso-8859-13.d.ts', typesCode);
